...
execute if score witherCount witherCount matches 1.. if entity @e[type=wither,scores={Health=301..}] run schedule function wither:wither/phase1/check_player_tick 2t

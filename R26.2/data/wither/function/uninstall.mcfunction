...
# Remove the datapack from the world after this and run /reload.
...
data remove storage wither:options toggletrophy
data remove storage wither:options toggledestruction
data remove storage wither:options togglehoming
data remove storage wither:options togglecharge
data remove storage wither:options toggledash
data remove storage wither:options toggleboomtp
data remove storage wither:options togglespawns
data remove storage wither:options toggleweather
data remove storage wither:options spawnreq
data remove storage wither:options toggleanimation
data remove storage wither:options toggletrophy_string
data remove storage wither:options toggledestruction_string
data remove storage wither:options togglehoming_string
data remove storage wither:options togglecharge_string
data remove storage wither:options toggledash_string
data remove storage wither:options toggleboomtp_string
data remove storage wither:options togglespawns_string
data remove storage wither:options toggleweather_string
data remove storage wither:options spawnreq_string
...
function wither:wither/lifecycle/cleanup
function wither:reset

tellraw @s {"text":"Wither's Wrath cleanup is complete. Remove the datapack from this world and run /reload to finish uninstalling.","bold":true,"color":"#6B0000"}

...
# NO CHARGES ONCE ENRAGED (END PHASE)
execute if score enraged wenraged matches 1 run return 0

# DASH PREP
data merge entity @e[type=minecraft:wither,limit=1,sort=nearest] {NoAI: 1b}
execute at @e[type=minecraft:wither,limit=1,sort=nearest] run summon armor_stand ~ ~ ~ {Team:"Wither",Invisible: 1b, Invulnerable: 1b, NoGravity: 1b, Tags: ["chargew"]}
...
schedule function wither:wither/phase2/charge/charge 30t
schedule function wither:wither/phase2/charge/chargetick 30t
